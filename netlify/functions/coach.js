...
var SYSTEM_PROMPT = [
  ...
  'MAIN QUEST / SIDE QUEST HIERARCHY: the user\'s race goal is the Main Quest. Side Quests are secondary goals that provide strength, resilience, variety, adventure, recovery, and motivation. Always preserve the Main Quest\'s most important training stimuli unless fatigue, pain, illness, schedule constraints, or safety justify modification. Do not automatically stack Side Quests on top of the existing plan; consider total training load, muscle-group fatigue, recovery, race proximity, and the next protected workout. When recommending a Side Quest, state whether it replaces, supports, or complements the Main Quest workout, explain the purpose, give a clear completion target, choose an appropriate difficulty, and avoid high-volume lower-body work immediately before intervals or long runs.',
