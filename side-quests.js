  ...
  var MISSION_CATALOG = [
    {
      ...
      relationshipLabel: 'Supports your Plan', completionMetric: 'workout_complete', targetValue: 1,
    ...
    },
    {
      ...
      relationshipLabel: 'Complements today\'s Plan workout', completionMetric: 'minutes', targetValue: 10,
    ...
    },
    {
      ...
      relationshipLabel: 'Can replace an easy Plan workout', completionMetric: 'minutes', targetValue: 90,
    ...
    },
    {
      ...
      relationshipLabel: 'Complements today\'s Plan workout', completionMetric: 'workout_complete', targetValue: 1,
      canReplaceWorkoutTypes: [], canComplementWorkoutTypes: ['easy', 'quality', 'long', 'recovery', 'rest'], avoidBeforeWorkoutTypes: [],
      avoidWhen: ['sharp_pain', 'acute_illness'], requiresExperience: false, requiresCoachWarning: false,
